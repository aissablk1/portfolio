...
const content = {
  fr: {
    ...
    dimensions: {
      ...
      accessibility: "Accessibilite (WCAG)",
    ...
    processing: {
      ...
      steps: [
        { label: "Resolution du domaine", detail: "Verification HTTPS et TTFB..." },
        { label: "Analyse SEO", detail: "Meta, titres, structure, sitemap..." },
        { label: "Performance", detail: "Temps de reponse, poids, scripts..." },
        { label: "Accessibilite", detail: "Heuristiques WCAG AA..." },
        { label: "Visibilite IA", detail: "llms.txt, schema, format Q&A..." },
        { label: "Securite", detail: "HTTPS, CSP, HSTS, headers..." },
        { label: "Credibilite", detail: "Signaux de confiance..." },
        { label: "Ponderation finale", detail: "Calcul du score global..." },
      ],
    },
    results: {
