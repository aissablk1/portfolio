...
<body style="margin:0;padding:0;background:#0a0a0a;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;">
  <div style="max-width:600px;margin:0 auto;padding:40px 24px;">
    ...
    <div style="margin-bottom:32px;">
      <a href="mailto:${esc(data.email)}?subject=Re: ${esc(data.need)}" style="display:inline-block;background:#ffffff;color:#0a0a0a;padding:12px 28px;border-radius:8px;text-decoration:none;font-size:13px;font-weight:600;text-transform:uppercase;letter-spacing:0.1em;">
        ${t.replyNow} &rarr;
      </a>
    </div>
      ...
      <tr>
        ...
        <td style="padding:16px 0;border-bottom:1px solid #1a1a1a;vertical-align:top;width:50%;">
          ...
          <p style="color:#fff;font-size:16px;margin:6px 0 0;">
            <a href="mailto:${esc(data.email)}" style="color:#fafafa;text-decoration:none;">${esc(data.email)}</a>
          </p>
        </td>
      </tr>
      <tr>
