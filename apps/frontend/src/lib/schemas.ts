    ...
    itemListElement: [
      {
        ...
        description:
          "Systeme livre cle en main. Documentation technique renforcee, formation autonomie 2h, licence d'usage complete. Aucune maintenance incluse.",
        price: "3900",
        priceCurrency: "EUR",
        priceSpecification: {
        ...
        itemOffered: {
          ...
          name: "Autonome",
          description:
            "1 systeme livre (site, automation ou dashboard), brief + maquette validee, licence d'usage complete, documentation technique renforcee, formation autonomie 2h.",
        },
      },
      {
        "@type": "Offer",
        ...
        itemOffered: {
          ...
          name: "Accelerateur",
          description:
            "1 systeme cle en main, licence d'usage complete, 3 mois monitoring + support offerts, corrections bugs sous 48h, MAJ securite continues, rapport mensuel.",
        },
      },
      {
        "@type": "Offer",
