                    ...
                    >
                      ...
                      <div className="flex flex-wrap gap-2 mt-4">
                        {post.tags.slice(0, 3).map((tag) => (
                          <span key={tag} className="text-[9px] font-bold uppercase tracking-widest text-site-text-light/50 bg-site-bg border border-site-border px-2 py-0.5 rounded-full">
                            {tag}
                          </span>
                        ))}
                      </div>
