...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      aria-label="WhatsApp"
      className="fixed bottom-24 lg:bottom-20 right-6 z-40 w-14 h-14 bg-[#25D366] text-white rounded-full flex items-center justify-center shadow-lg hover:scale-110 transition-transform"
    >
