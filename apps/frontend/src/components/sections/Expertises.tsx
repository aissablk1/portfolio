        ...
        <div className="grid grid-cols-1 divide-y divide-site-border">
          {dict.expertises.items.map((item, idx) => (
            <motion.div
              ...
              className="bg-site-bg py-8 md:py-12 flex items-center justify-between group cursor-pointer hover:px-8 transition-all duration-500"
            >
              <h3 className="text-2xl md:text-4xl lg:text-5xl group-hover:italic transition-all">
                {item}
              </h3>
